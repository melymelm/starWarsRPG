$(document).ready(function() {
	...
	//object for our characters
	var characters = {
		"Obi-Wan Kenobi": {
			name: "Obi-Wan Kenobi",
			health: 120,
			attack: 8,
			imageUrl: "./assets/images/obiWan_400x336.jpg",
			enemyAttackBack: 15
		},
		"Luke Skywalker": {
			name: "Luke Skywalker",
			health: 100,
			attack: 14,
			imageUrl: "./assets/images/lukeSkywalker_400x362.jpg",
			enemyAttackBack: 5
		},
		"Darth Sidious": {
		    name: "Darth Sidious",
		    health: 150,
		    attack: 8,
		    imageUrl: "./assets/images/darthSidious_400x354.jpg",
		    enemyAttackBack: 20
		},
		"Darth Maul": {
		    name: "Darth Maul",
		    health: 180,
		    attack: 7,
		    imageUrl: "assets/images/darthMaul_400x544.jpg",
		    enemyAttackBack: 25
		}
	};
